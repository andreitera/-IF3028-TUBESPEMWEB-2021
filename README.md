...
4. Ubah **Penjelasan Teknis** pada bagian bawah readme.md ini dengan menjelaskan bagaimana cara anda:
   ...
   - Nazla Andintya Wijaya 118140084
   - Cara Intalasi
   - Download Composer
   - Git Clone https://github.com/vinaoktariana/-IF3028-TUBESPEMWEB-2021.git
   - Buka Git Bash pada folder -IF3028-TUBESPEMWEB-2021
   - Buat database dengan nama "laravel"
   - Import laravel.sql didalam folder -IF3028-TUBESPEMWEB-2021
