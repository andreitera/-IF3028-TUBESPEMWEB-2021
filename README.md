...
- sesuaikan nama folder hasil ekstrak dengan config.php (terdapat pada direktori C:/xampp/htdocs/application/config/config.php) "$config['base_url'] = 'http://localhost/**014_108**';"
