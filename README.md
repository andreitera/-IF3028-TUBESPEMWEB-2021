### Anggota Kelompok
1. YOGA NAUFAL RAY PUTRO - 14117099
2. Rivaldi Heriyan - 13117099
...
![](assets/lampiran/dok_laporan.PNG)
...
![](assets/lampiran/dok_cari1.PNG)
![](assets/lampiran/dok_cari2.PNG)
...
`YOGA NAUFAL RAY PUTRO | 1411099 | Front-End & Back-End`

`Rivaldi Heriyan | 13117099 | Front-End & Back-End`
...
- sesuaikan nama folder hasil ekstrak dengan base url (terdapat pada direktori C:/xampp/htdocs/application/config/config.php) `$config['base_url'] = 'http://localhost/` **tubesWEB2020** `';`
- Buka Browser dan jalankan "localhost/tubesWEB2020"
- Selesai
