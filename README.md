...
- Bagian ini menampilkan hasil pencarian kata `saja`.

### Penjelasan Teknis

`Penjelasan Teknis dan cara Instalasi.`

`Gabriel Batubara | 14116039 | Front-End, Back-End & Database`
...
- Download Project terlebih dahulu.
- Kemudian esktrak procject ke dalam folder C:/xampp/htdocs.
- Kemudian buat database dengan nama "db_lapor"
- Import file db_lapor.sql.
- Sesuaikan nama folder hasil ekstrak dengan base url (terdapat pada direktori C:/xampp/htdocs/application/config/config.php) `$config['base_url'] = 'http://localhost/` **14116039** `';`
- Buka Browser dan jalankan "localhost/14116039"
- Selesai
