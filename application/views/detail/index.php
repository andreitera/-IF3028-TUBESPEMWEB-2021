...
<div class="container">
	...
	<ul>
		<li>
			...
			<?php 
				$ekstensifile = explode('.',$lapor["file"]); //fungsi untuk memecah string dengan pemecah . ,aldi.jpg = ['aldi','jpg']
			...
			<a href="<?php echo base_url() ?>index.php/Home/delete/<?php echo $lapor["id"]?>" onclick="return confirm('Apakah anda yakin untuk menghapus?');"><h4 class="hapus">| Hapus laporan / komentar</h4></a>
