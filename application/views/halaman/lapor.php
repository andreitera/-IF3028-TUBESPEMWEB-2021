...
<body>
	...
	<fieldset>
			...
			<div class="container">
				<center>
					<h1><a href="<?php echo base_url() ?>" style="color: white; text-decoration: none;">Layanan Aspirasi
							dan Pengaduan Mahasiswa ITERA <br>
		...
		<section id="buatlaporan">
			<div class="container">
				<center>
					<a href="<?php echo base_url() . 'control/report' ?>">Buat Laporan/Komentar</a> <span style="font-style:bold; padding: 1px 2px;background-color: #000; color: #fff;">+</span>
				</center>
			</div>
		</section>
