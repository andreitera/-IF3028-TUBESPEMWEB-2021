        ...
        <div class="container">
            ...
            <nav id="nav-show" class="d-flex align-items-center justify-content-lg-between">
                ...
                <ul class="nav-list text-center p-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url().'home#about' ?>">Tentang Lapor!</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url().'home#laporan' ?>">Laporan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url().'home#footer' ?>">Copyright</a>
                    </li>
                </ul>
            </nav>
            <div class="hero-text w-100 text-white px-2 px-sm-0">
                <h1 class="display-4">Layanan Aspirasi dan Pengaduan Online ITERA</h1>
                <p class="lead mb-4">Sampaikan laporan Anda langsung kepada instansi ITERA berwenang</p>
