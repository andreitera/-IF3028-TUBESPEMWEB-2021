...
function addTodosToPage(){
    ...
    for (var i = 0; i < todos.length; i++){
        ...
        li.innerHTML = todoItem.who + "needs to " + todoItem.task + " by" + todoItem.dueDul.appendChild(li);
    }
}
...
function getFormData(){
    ...
    var todoItem = new todos(task, who, date);
    todos.push(todoItem);
    saveTodoData();
}
...
function addTodoToPage(todoItem){
    ...
    li.innerHTML = todoItem.who + " needs to " + todoItem.task + " by " + todoItem.dueData;
    ul.appendChild(li);
