...
<div class="container">
    ...
    <div class="main">
        ...
        <form action="/process/update/{{$data->id}}" method="post" enctype="multipart/form-data" onsubmit="return validation()">
            {{csrf_field()}}

            <textarea name="komentar" id="komentar">{{$data->komentar}}</textarea>
