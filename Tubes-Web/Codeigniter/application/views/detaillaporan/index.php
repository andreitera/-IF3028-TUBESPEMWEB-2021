        ...
        <ul>
            <li>
                ...
                ?>
                    ...
                    <a href="<?php echo base_url() ?>index.php/home/delete/<?php echo $lapor["id"]?>" onclick="return confirm('apakah anda yakin ingin menghapus?');"><h4 class="hapus">| Hapus Laporan</h4></a>

                    <a href="<?php echo base_url() ?>index.php/home/detail_ubah/<?php echo $lapor["id"]?>"><h4 class="hapus">Edit Laporan</h4></a>
