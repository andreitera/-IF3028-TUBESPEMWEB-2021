...
<div class="container" >
	...
	<input type="text" name="cari" id="cari" placeholder="Cari laporan/komentar yang ingin dicari...">   </input>
	...
	<footer>
		...
		&copyCopyright 2020 - <a href="https://itera.ac.id">Institut Teknologi Sumatera<br><br>
		<img src="asset/css/logo2.png" style="height:50px;">
	</footer>
</div>
