...
<div class="container">
	...
	<ul>
		<li>
			...
			<?php 
				$ekstensifile = explode('.',$lapor["file"]); //fungsi untuk mecah string dengan pemecah . ,FrostNova.jpg = ['FrostNova','jpg']
				$ekstensifile = strtolower(end($ekstensifile));
				if($ekstensifile == "pdf"){
			?>
			<embed src="<?php echo base_url() ?>/asset/file/<?php echo $lapor["file"]; ?>" />
			<?php } else { ?>
			<img id="filedetail" style="width: 100%;" src="<?php echo base_url() ?>/asset/file/<?php echo $lapor["file"]; ?>">
			<?php } ?>
